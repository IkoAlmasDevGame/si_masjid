...
<html lang="en">
    ...
    <head>
        ...
        <title>Edit Rekening Bank Masjid</title>
            ...
            <div class="panel-body container-fluid py-5">
                <div class="panel-heading">
                    <h4 class="panel-title display-4 fs-2"
                        style="font-weight: 500; font-family: 'Times New Roman', monospace;">Edit Rekening Bank Masjid
                    </h4>
                    <div class="breadcrumb d-flex justify-content-end align-items-end flex-wrap">
                        ...
                        <li class="breadcrumb breadcrumb-item">
                            <a href="?aksi=edit-rekening&id=<?= $_GET['id'] ?>" aria-current="page"
                                class="text-decoration-none active">Edit
                                Rekening Bank Masjid</a>
                        </li>
                    </div>
                </div>
                <hr class="text-dark">
                                ...
                                <div class="d-flex justify-content-center align-items-center flex-wrap">
                                    <div class="card shadow bg-secondary col-sm-7 col-md-7">
                                        ...
                                        <div class="card-body my-3">
                                            ...
                                            <?php $SQL = $koneksi->query("SELECT * FROM bank WHERE id = '$_GET[id]'"); ?>
                                            <?php foreach ($SQL as $isi): ?>
                                            <form action="?aksi=rekening-edit" class="form-group" method="post">
