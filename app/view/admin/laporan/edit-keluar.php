            ...
            <div class="panel-body container-fluid py-5">
                <div class="panel-heading">
                    <h4 class="panel-title display-4 fs-2"
                        style="font-weight: 500; font-family: 'Times New Roman', monospace;">Edit Uang Keluar</h4>
                    <div class="breadcrumb d-flex justify-content-end align-items-end flex-wrap">
                        ...
                        <li class="breadcrumb breadcrumb-item">
                            <a href="?aksi=edit-laporan-keluar&tanggal=<?= $_GET['tanggal'] ?>" aria-current="page"
                                class="text-decoration-none active">Edit Uang Keluar</a>
                        </li>
                    </div>
                </div>
                <hr class="text-dark">
                            ...
                            <div class="card shadow bg-secondary col-sm-7 col-md-7">
                                <div class="card-header py-2">
                                    <h4 class="card-title text-center"
                                        ...
                                        Edit Laporan Uang Keluar
                                    </h4>
                                </div>
                                <div class="card-body my-2">
                                    <?php if (isset($_GET['tanggal'])): ?>
                                    <?php $SQL = $koneksi->query("SELECT * FROM laporan_keuangan WHERE tgl_keluar = '$_GET[tanggal]'"); ?>
                                    <?php foreach ($SQL as $isi): ?>
                                    <?php extract($isi); ?>
                                    <form action="?aksi=laporan-ubah-keluar" method="post" class="form-group">
                                            ...
                                            <div class="row justify-content-center align-items-center flex-wrap">
                                                ...
                                                <div class="col-sm-7 col-md-7">
                                                    <input type="date" class="form-control date-formate"
                                                        name="tgl_keluar" value="<?= $tgl_keluar ?>" readonly
                                                        id="tanggal_keluar" aria-required="TRUE">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-inline my-2">
                                            <div class="row justify-content-center align-items-center flex-wrap">
                                                ...
                                                <div class="col-sm-7 col-md-7">
                                                    <input type="text" inputmode="numeric"
                                                        ...
                                                        value="<?= $uang_keluar ?>" name="uang_keluar" id="uang_keluar"
                                                        aria-required="TRUE"
                                            ...
                                            <div class="row justify-content-center align-items-start flex-wrap">
                                                ...
                                                <div class="col-sm-7 col-md-7">
                                                    <textarea name="ket_keluar"
                                                        ...
                                                        rows="4" cols="10"><?php echo $ket_keluar; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="my-2"></div>
